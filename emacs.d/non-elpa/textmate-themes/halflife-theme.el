;; default {'caret': '#ffffff', 'foreground': '#cccccc', 'selection': '#333333', 'findHighlight': '#FFE792', 'bracketContentsOptions': 'underline', 'invisibles': '#3B3A32', 'bracketContentsForeground': '#F8F8F2A5', 'lineHighlight': '#282828', 'bracketsOptions': 'underline', 'tagsOptions': 'stippled_underline', 'findHighlightForeground': '#000000', 'activeGuide': '#9D550FB0', 'background': '#222222', 'selectionBorder': '#282828', 'bracketsForeground': '#F8F8F2A5'}
;; comment {'foreground': '#555555'}
;; string {'foreground': '#F9D423'}
;; constant.numeric {'foreground': '#F9D423'}
;; constant.language {'foreground': '#F9D423'}
;; constant.character, constant.other {'foreground': '#F9D423'}
;; variable {'fontStyle': ''}
;; keyword {'foreground': '#7D8991'}
;; storage {'foreground': '#7D8991', 'fontStyle': ''}
;; storage.type {'foreground': '#F2EFE6', 'fontStyle': 'italic'}
...
;; entity.name.tag {'foreground': '#7D8991', 'fontStyle': ''}
...
(deftheme halflife
  "HalfLife emacs theme autoconverted from the textMate theme by unknown")
(custom-theme-set-faces
  'halflife
    ...
    '(font-lock-doc-face ((t (:foreground "#f9d423" ))))
    '(font-lock-function-name-face ((t (:foreground "#f85931" ))))
    '(font-lock-keyword-face ((t (:foreground "#7d8991" ))))
    '(font-lock-negation-char-face ((t (:foreground "#7d8991" ))))
    '(font-lock-regexp-grouping-backslash ((t (:foreground "#f9d423" ))))
    '(font-lock-regexp-grouping-construct ((t (:foreground "#f9d423" ))))
    '(font-lock-string-face ((t (:foreground "#f9d423" ))))
    '(font-lock-type-face ((t (:foreground "#f2efe6" :italic t ))))
    ...
    '(menu ((t (:foreground "#cccccc" :background "#222222" ))))
    '(mode-line ((t (:box "#282828" :background "#333333" ))))
    '(mode-line-buffer-id ((t (:foreground "#7d8991" ))))
    '(mode-line-emphasis ((t (:bold t ))))
    '(mode-line-highlight ((t (:italic t ))))
    '(mode-line-inactive ((t (:box "#282828" :background "#282828" ))))
    '(org-agenda-dimmed-todo-face ((t (:foreground "#555555" ))))
    ...
    '(show-paren-match-face ((t (:background "#333333" ))))
