;;; po-elscreen.el ---  Screen for Emacsen(this is not original. original is http://www.morishima.net/~naoto/elscreen-en/?lang=en)
;; -*- Mode: Emacs-Lisp -*-
;;
;; po-elscreen.el
;;
...
;;
;; Author:   Naoto Morishima(original) <naoto@morishima.net>, po
;; Based on: screens.el
